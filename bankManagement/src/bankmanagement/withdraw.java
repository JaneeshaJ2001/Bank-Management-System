...
public class withdraw extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(10, 96, 300, 30);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(10, 156, 290, 30);
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(10, 206, 290, 30);
        ...
        jPanel1.add(jLabel9);
        jLabel9.setBounds(1060, 0, 80, 50);
        ...
        jLabel10.setBounds(1170, 0, 70, 50);
        ...
        jButton1.setBounds(620, 605, 340, 40);
        ...
        jTextField2.setBounds(620, 162, 220, 20);
        ...
        jTextField3.setBounds(950, 116, 220, 20);
        ...
        jTextField5.setBounds(700, 335, 130, 30);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/system images/withdraw.png"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (validWithdraw()) {
            try {
                ...
                paa.setString(2, "Withdraw");
                paa.setInt(3, 0);
                paa.setDouble(4, 0.0);
                paa.setDouble(5, withdraw);
                paa.setDouble(6, balance - withdraw);
                paa.setString(7, date);
                
                if (paa.executeUpdate() != 0) {
                    JOptionPane.showMessageDialog(null, "Your withdrawal has been Succfully Performed !");
                    jTextField5.setText("");
                    getBalance();
                } else {
    ...
    public boolean validWithdraw() {
        withdraw = Double.parseDouble(jTextField5.getText());
        
        if (jTextField5.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Please Enter Pay Amount Of withdrawal", "Error", 2);
            return false;
            ...
            JOptionPane.showMessageDialog(null, "Your Current Balance Isn't Enough To Withdraw !", "Error", 2);
            return false;
        }else{
            return true;
        }

 ...
 * @author Janeesha
 */
public class manPage extends javax.swing.JFrame {

    /**
     * Creates new form manPage
     */
    public manPage() {
        initComponents();
        setLocationRelativeTo(null);
        //calculateBalance c = new calculateBalance(1235);
        //System.out.println(c.getLastBalance());
    ...
    private void initComponents() {
        ...
        customerIcon.setBounds(910, 0, 100, 50);
        ...
        homeIcon.setBounds(1150, 0, 90, 50);
        ...
        adminIcon.setBounds(1030, 0, 90, 50);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/system images/welcome page.png"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
